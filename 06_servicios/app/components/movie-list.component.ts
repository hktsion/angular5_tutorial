...
export class MovieListComponent{
	...
	private datoServicio;

	//El servicio debe estar dentro del constructor;
	constructor(private _movieService:MovieService){  
		this.title = 'LISTADO DE PELÍCULAS';
		this.movies = [];
		this.palabro = '';

		//Acumulamos el dato del servicio desde el componente
		this.datoServicio = this._movieService.saludar();
